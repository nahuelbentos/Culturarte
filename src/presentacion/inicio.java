...
public class inicio extends JFrame {
	...
	public void crearInternalFrameAltaCategoria() {
		intFrameAltaCategoria = new JInternalFrame("Alta de Categor�a");
		...
		panelAltaCategoria.add(lblListaDeCategorias);
		listarCategorias();
		panelAltaCategoria.add(treeListaDeCategorias);
	}
	
	public void listarCategorias() {
        DefaultMutableTreeNode categorias = new DefaultMutableTreeNode("Categor�as");
        DefaultMutableTreeNode teatro = new DefaultMutableTreeNode("Teatro");
        DefaultMutableTreeNode musica = new DefaultMutableTreeNode("M�sica");
        ...
        DefaultMutableTreeNode rockClasico = new DefaultMutableTreeNode("Rock cl�sico");
